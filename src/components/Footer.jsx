          ...
          <div className="footer__brand">
            <a href="#accueil" className="footer__logo">
              <svg className="footer__logo-icon" viewBox="0 0 64 64" fill="none">
                ...
                <path d="M32 16L32 48" stroke="#0B1D2E" strokeWidth="5" strokeLinecap="round"/>
                <path d="M16 32L48 32" stroke="#0B1D2E" strokeWidth="5" strokeLinecap="round"/>
              </svg>
              <span className="footer__logo-name">ESFS</span>
            </a>
            <p className="footer__desc">
              L'École Supérieure de Formation en Santé s'engage à former 
